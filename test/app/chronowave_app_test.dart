...
void main() {
  ...
  testWidgets('shows the ChronoWave technical starting point in Spanish', (tester) async {
  ...
  testWidgets('navigates through the phase one localized workspace sections', (tester) async {
    await tester.pumpWidget(const ChronoWaveApp());
    await tester.pumpAndSettle();
    ...
    // Navegar a Ajustes
    await tester.tap(find.text('Ajustes').last); // Tocar la pestaña en el nav bar (último)
    await tester.pumpAndSettle();
